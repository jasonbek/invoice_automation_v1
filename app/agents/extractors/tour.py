...
{{
  ...
  "clientFeedback": "Chronological day-by-day itinerary as a plain text block. Synthesize ALL invoice data (hotels, flights, transfers, activities, meals) into a single timeline ordered by date. Do NOT group by category (no separate ACCOMMODATION / FLIGHTS sections).\\n\\nBegin with this exact header on its own lines:\\n  Itinerary at a glance\\n  ----------------------\\n\\nThen one entry per calendar day from startDate to endDate in this format:\\n\\nDay 1 — MM/DD/YY (City)\\n  Arrive [city] on flight [XX123] from [origin] at [time].\\n  Check in: [Hotel Name] ([room type]).\\n  [Any included meals, transfers, activities for that day].\\n\\nDay 2 — MM/DD/YY (City)\\n  [Activities / at leisure / transfers].\\n  [Meals included].\\n\\n...continue for every day through the final day.\\n\\nRules:\\n- Use every date on the invoice (flight dates, check-in/out, activity dates) to place events on the correct day.\\n- On travel days, note both the departure and arrival city.\\n- If a day has no listed activity, write 'At leisure in [city].'\\n- On check-out days, note the checkout and the next accommodation/flight.\\n- End with a 'Confirmation Numbers:' block listing hotel/flight confirmations.\\n- DO NOT include pricing, commission, deposits, or any financial figures."
}}
